...
namespace VistoriaApp.Migrations
{
    ...
    [Migration("20231205225548_CriandoTblUsuario-v3")]
    partial class CriandoTblUsuariov3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VistoriaApp.Models.UsuarioModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VistoriaApp.Models.AmbienteModel", b =>
                {
                    b.HasOne("VistoriaApp.Models.VistoriaModel", "VistoriaModel")
                        .WithMany("Ambiente")
                        .HasForeignKey("VistoriaModelId");

                    b.Navigation("VistoriaModel");
                });
            ...
            modelBuilder.Entity("VistoriaApp.Models.VistoriaModel", b =>
                {
                    b.HasOne("VistoriaApp.Models.ImovelModel", "Imovel")
                        .WithOne("Vistoria")
                        .HasForeignKey("VistoriaApp.Models.VistoriaModel", "ImovelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VistoriaApp.Models.VistoriadorModel", "Vistoriador")
                        .WithMany("Vistoria")
